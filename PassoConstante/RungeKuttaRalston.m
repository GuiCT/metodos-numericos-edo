function sol = RungeKuttaRalston(f, tspan, u0, h)
% sol = RungeKuttaRalston(f, tspan, u0, h)
% Executa um método numérico de Runge-Kutta Ralston de 4a ordem.
% INPUTS:
...
sol = simple_step(f, tspan, u0, h, 'RKR');
endfunction